      ...
      <main className="max-w-4xl w-full">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
            <li>
                <h3>目的</h3>
                <p>本開発ガイドラインは、クラウドを前提とした医療情報システムの開発指針を提供します。</p>
            </li>
            <li>
                <h3>期待される効果</h3>
                <p>本ガイドラインに準拠した開発により、以下のメリットを社会全体で享受できます：</p>
                <ul>
            ...
            <li>
                <h3>ビジョン</h3>
                <p>オープンソースとして管理・運用され、以下を目指します：</p>
                <ul>
                    <li>日本国内の医療情報システム開発企業の開発力向上</li>
                    <li>医療システム産業のオールジャパンでの活性化</li>
                </ul>
            </li>
          </ul>
        </section>
